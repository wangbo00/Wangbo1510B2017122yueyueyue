...
import wangbo.bawei.com.wangbo1510b20171221.adapter.ExpandableAdapter;
import wangbo.bawei.com.wangbo1510b20171221.bean.ChildBean;
import wangbo.bawei.com.wangbo1510b20171221.bean.GroupBean;
import wangbo.bawei.com.wangbo1510b20171221.bean.ShopCarBean;
import wangbo.bawei.com.wangbo1510b20171221.dingdan.Dingdan;
...
public class MainActivity extends AppCompatActivity implements ImView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_play = (TextView) findViewById(R.id.tv_go_to_pay);

        tv_play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, Dingdan.class);
