...
import wangbo.bawei.com.wangbo1510b20171221.MainActivity;
...
import wangbo.bawei.com.wangbo1510b20171221.view.AddDeleteView;
...
public class ExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int i, final int i1, boolean b, View v, ViewGroup viewGroup) {
        //加载视图
        v=View.inflate(context, R.layout.ex_chid_item ,null);
